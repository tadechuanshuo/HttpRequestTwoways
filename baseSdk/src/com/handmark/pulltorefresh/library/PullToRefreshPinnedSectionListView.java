...
public class PullToRefreshPinnedSectionListView extends PullToRefreshAdapterViewBase<ListView> {
	...
	void createPinnedShadow(int position) {
		...
		View pinnedView = mRefreshableView.getAdapter().getView(position, pinnedShadow.view, PullToRefreshPinnedSectionListView.this);
		...
		int maxHeight = getHeight() - mRefreshableView.getListPaddingTop() - mRefreshableView.getListPaddingBottom();
		if (heightSize > maxHeight) heightSize = maxHeight;

		// measure & layout
		int ws = MeasureSpec.makeMeasureSpec(getWidth() - mRefreshableView.getListPaddingLeft() - mRefreshableView.getListPaddingRight(), MeasureSpec.EXACTLY);
		...
		pinnedShadow.id = mRefreshableView.getAdapter().getItemId(position);
    ...
    void ensureShadowForPosition(int sectionPosition, int firstVisibleItem, int visibleItemCount) {
        ...
        if (nextPosition < mRefreshableView.getCount()) {
	...
	void recreatePinnedShadow() {
        ...
        if (adapter != null && adapter.getCount() > 0) {
            ...
            ensureShadowForPosition(sectionPosition,
                    firstVisiblePosition, mRefreshableView.getLastVisiblePosition() - firstVisiblePosition);
        }
	}
	...
	public void setAdapter(ListAdapter adapter) {
		...
		ListAdapter oldAdapter = mRefreshableView.getAdapter();
	...
	protected void dispatchDraw(Canvas canvas) {
		...
		if (mPinnedSection != null) {
			...
			// prepare variables
			int pLeft = mRefreshableView.getListPaddingLeft();
			int pTop = mRefreshableView.getListPaddingTop();
    ...
    private boolean performPinnedItemClick() {
        ...
        OnItemClickListener listener = mRefreshableView.getOnItemClickListener();
        if (listener != null && mRefreshableView.getAdapter().isEnabled(mPinnedSection.position)) {
            View view =  mPinnedSection.view;
            playSoundEffect(SoundEffectConstants.CLICK);
            if (view != null) {
                view.sendAccessibilityEvent(AccessibilityEvent.TYPE_VIEW_CLICKED);
            }
            listener.onItemClick(this.getRefreshableView(), view, mPinnedSection.position, mPinnedSection.id);
            return true;
        }
        return false;
    }
