...
/**
 * 修改的地方：（1）增加方法 {@link #setSlideable(boolean)}； （2）改变参数DEFAULT_OVERHANG_SIZE
 */
public class YmSlidingPaneLayout extends ViewGroup {
    private static final String TAG = "YmSlidingPaneLayout";
...
//    private static final int DEFAULT_OVERHANG_SIZE = 32; // dp;
    ...
    public YmSlidingPaneLayout(Context context) {
        this(context, null);
    }

    public YmSlidingPaneLayout(Context context, AttributeSet attrs) {
    ...
    public YmSlidingPaneLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        /** 设置默认的响应宽度，系统默认的是20dip，偏小 */
        setEdgeWidth(100);
    }
    
    /**
     * 设置右滑退出边缘响应区域的宽度大小
     * @param dip 从屏幕左边沿向右的宽度
     */
    ...
    interface SlidingPanelLayoutImpl {
        void invalidateChildRegion(YmSlidingPaneLayout parent, View child);
    }

    static class SlidingPanelLayoutImplBase implements SlidingPanelLayoutImpl {
        public void invalidateChildRegion(YmSlidingPaneLayout parent, View child) {
    ...
    class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
            ...
            info.setClassName(YmSlidingPaneLayout.class.getName());
            info.setSource(host);
        ...
        public void onInitializeAccessibilityEvent(View host, AccessibilityEvent event) {
            ...
            event.setClassName(YmSlidingPaneLayout.class.getName());
        }
    ...
    private class DisableLayerRunnable implements Runnable {
        ...
        @Override
        public void run() {
            if (mChildView.getParent() == YmSlidingPaneLayout.this) {
