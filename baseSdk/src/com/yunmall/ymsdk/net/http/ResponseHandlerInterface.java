...
public interface ResponseHandlerInterface {
    ...
    /**
     * Notifies callback, that request was handled by cache file
     *
     * @param responseBody returned data
     * @param cacheTime    time when the cache had benn saved
     */
    void sendCacheMessage(byte[] responseBody, long cacheTime);
     ...
     * the first and last markers is greater than {MIN_DURATION_FOR_LOGGING_MS}.
