...
public class AsyncHttpClient {
    ...
    //Cache有效期默认为24小时
    public static final int DEFAULT_CACHE_EXPIRATION_TIME = 24*60*60*1000;
     ...
     * @see com.yunmall.ymsdk.net.http.MyRedirectHandler
     */
    ...
    public static void silentCloseInputStream(InputStream is) {
        try {
            ...
            YmLog.w(LOG_TAG, "Cannot close input stream", e);
        }
    }
    ...
    public static void silentCloseOutputStream(OutputStream os) {
        try {
            ...
            YmLog.w(LOG_TAG, "Cannot close output stream", e);
        }
    }
