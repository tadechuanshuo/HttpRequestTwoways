...
public class RequestParams implements Serializable {
    ...
    public void setContentEncoding(final String encoding) {
        if (encoding != null)
            ...
            YmLog.d(LOG_TAG, "setContentEncoding called with null attribute");
    }
    ...
    /**
     * Get string value in urlParams if a parameter is defined.
     *
     * @param key the key name for the parameter to check existence.
     * @return String
     */
    ...
    /**
     * Get ket Set<String> in urlParams if a parameter is defined.
     *
     * @return Set<String>
     */
    ...
    private HttpEntity createFormEntity() {
        try {
            ...
            urlEncodedFormEntity.setContentType(new BasicHeader("Content-Type", "application/x-www-form-urlencoded;charset=utf-8"));
